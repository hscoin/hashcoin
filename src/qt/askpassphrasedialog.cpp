...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm FoxHole barricade"),
                 tr("WARNING: If you barricade your FoxHole and lose your passphrase, you will <b>LOSE ALL OF YOUR HSCoins!!!!</b>!\nAre you sure you wish to barricade your FoxHole?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("FoxHole barricaded"),
                                         tr("HSCoin will close now to finish the barricade process. Remember that barricading your FoxHole cannot fully protect your HSCoin from being stolen by malware infecting your computer."));
                    QApplication::quit();
                }
                else
                {
