...
{
    resize(850, 550);
    setWindowTitle(tr("HSCoin") + " - " + tr("HSCHole"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&HSCDen"), this);
    overviewAction->setToolTip(tr("Show general overview of your HSCHole"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About HSCoin"), this);
    aboutAction->setToolTip(tr("Show information about HSCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for HSCoin"));
    ...
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Barricade HSCHole..."), this);
    encryptWalletAction->setToolTip(tr("Barricade or de-barricade HSCHole"));
    encryptWalletAction->setCheckable(true);
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup HSCHole..."), this);
    backupWalletAction->setToolTip(tr("Backup HSCHole to another location"));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&Reinforce Barricade..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for HSCHole barricade"));
    ...
    protectionTutorialAction->setToolTip(tr("A beginners guide to barricading HSCHoles."));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("HSCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("HSCHole client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide HSCoin"
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Locked:
        ...
        labelEncryptionIcon->setToolTip(tr("HSCHole is <b>barricaded</b> and currently <b>locked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
        encryptWalletAction->setEnabled(false); // TODO: decrypt currently not supported
        break;
...
void BitcoinGUI::backupWallet()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, tr("Backup HSCHole"), saveDir, tr("HSCHole Data (*.dat)"));
    if(!filename.isEmpty()) {
        if(!walletModel->backupWallet(filename)) {
            QMessageBox::warning(this, tr("Backup Failed"), tr("There was an error trying to save the HSCHole data to the new location."));
        }
    }
}
