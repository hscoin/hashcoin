...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of hscoin"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the hscoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or hscoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: hscoind.pid)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart hscoin to complete"),
